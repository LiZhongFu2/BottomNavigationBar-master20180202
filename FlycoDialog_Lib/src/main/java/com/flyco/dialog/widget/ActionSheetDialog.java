...
public class ActionSheetDialog extends BottomBaseDialog<ActionSheetDialog> {
    ...
    private int mTitleTextColor = Color.parseColor("#f4a805");
    ...
    private int mItemTextColor = Color.parseColor("#f4a805");
    ...
    private int mCancelTextColor = Color.parseColor("#f4a805");
